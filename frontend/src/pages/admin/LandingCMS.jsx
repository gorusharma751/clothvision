  ...
  return (
    <Layout title="Landing Page Editor" subtitle="Edit your public landing page content"
      ...
      <div style={{display:'flex',flexDirection:'column',gap:16,maxWidth:900}}>
        ...
        <div style={{background:'#111118',border:'1px solid #1e1e2d',borderRadius:16,padding:20}}>
          ...
          {stats.map((s,i)=>(
            <div key={i} style={{display:'flex',gap:8,marginBottom:8,alignItems:'center'}}>
              <input className="cv-input" value={s.value} onChange={e=>updateArr(stats,setStats,i,'value',e.target.value)} placeholder="30+" style={{fontSize:13,flex:'0 0 100px'}}/>
              <input className="cv-input" value={s.label} onChange={e=>updateArr(stats,setStats,i,'label',e.target.value)} placeholder="Categories" style={{fontSize:13,flex:1}}/>
        ...
        <div style={{background:'#111118',border:'1px solid #1e1e2d',borderRadius:16,padding:20}}>
          ...
          {features.map((f,i)=>(
            <div key={i} style={{display:'flex',gap:8,marginBottom:8,alignItems:'flex-start'}}>
              ...
              <input className="cv-input" value={f.title} onChange={e=>updateArr(features,setFeatures,i,'title',e.target.value)} placeholder="Feature name" style={{fontSize:13,flex:'0 0 160px'}}/>
              <input className="cv-input" value={f.desc} onChange={e=>updateArr(features,setFeatures,i,'desc',e.target.value)} placeholder="Description" style={{fontSize:13,flex:1}}/>
        ...
        <button onClick={save} disabled={saving} className="btn-primary" style={{alignSelf:'flex-start',padding:'10px 28px',fontSize:'.9rem'}}>
